...
const { useGetOffersMutation, useAcceptOfferMutation, useRejectOfferMutation } = offerApi;

export { useAcceptOfferMutation, useGetOffersMutation, useRejectOfferMutation };
